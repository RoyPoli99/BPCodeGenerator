...
function addLinePermutationBthreads(l) {
  ...
  bp.registerBThread("AddThirdX(<" + l[0].x + "," + l[0].y + ">," + "<" + l[1].x + "," + l[1].y + ">," + "<" + l[2].x + "," + l[2].y + ">)", function() {
    while (true) {
      bp.sync({waitFor: [X(l[0].x, l[0].y), X(l[1].x, l[1].y), X(l[2].x, l[2].y)]});
      bp.sync({waitFor: [X(l[0].x, l[0].y), X(l[1].x, l[1].y), X(l[2].x, l[2].y)]});
      bp.sync({request: [X(l[0].x, l[0].y), X(l[1].x, l[1].y), X(l[2].x, l[2].y)]}, 50);
    }
  });

  // Player X strategy to prevent the third O of player O
  bp.registerBThread("PreventThirdO(<" + l[0].x + "," + l[0].y + ">," + "<" + l[1].x + "," + l[1].y + ">," + "<" + l[2].x + "," + l[2].y + ">)", function() {
    while (true) {
      bp.sync({waitFor: [O(l[0].x, l[0].y), O(l[1].x, l[1].y), O(l[2].x, l[2].y)]});
      bp.sync({waitFor: [O(l[0].x, l[0].y), O(l[1].x, l[1].y), O(l[2].x, l[2].y)]});
      bp.sync({request: [X(l[0].x, l[0].y), X(l[1].x, l[1].y), X(l[2].x, l[2].y)]}, 40);
    }
  });
}
